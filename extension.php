...
return [
	...
	*/
	...
	'description' => 'Package to manage git packages',
	...
	*/
	...
	'providers' => [
		'Sanatorium\Githelper\Providers\GithelperServiceProvider'
	],
	...
	*/
	...
	'routes' => function(ExtensionInterface $extension, Application $app)
	{
		...
		Route::group([
			'prefix' => admin_uri() . '/githelper',
			'namespace' => 'Sanatorium\Githelper\Controllers\Admin'
		], function(){
            ...
            Route::group([
                ...
                Route::get('patch', ['as' => 'sanatorium.githelper.bulk.patch', 'uses' => 'GithelpersController@bulkPatch']);
            });
	...
	*/
	...
	'menus' => [
		...
		'admin' => [
			...
			[
				'slug'  => 'admin-sanatorium-githelper',
				'name'  => 'Githelper',
				'class' => 'fa fa-git',
				'uri'   => 'githelper',
				'regex' => '/:admin\/githelper/i',
			],
